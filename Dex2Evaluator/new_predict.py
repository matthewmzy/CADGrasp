...
@hydra.main(version_base="v1.2", config_path='.', config_name='predict')
def main(cfg: DictConfig):
    a=generate_based_on_scene_obs(
        "LASDiffusion/results/LEAP_dif/recent/last.ckpt",
        1,1,1
    )
