...
class RobotModel:
    ...
    def __init__(
        ...
        # Define link names for thumb and other fingers (for LEAP hand)
        self.thumb_link_names = ['thumb_dip', 'thumb_fingertip', 'thumb_pip']
        self.other_finger_link_names = ['pip', 'pip_2', 'pip_3', 'dip', 'dip_2', 'dip_3', 'fingertip', 'fingertip_2', 'fingertip_3']
    ...
    def get_finger_surface_points(
        ...
        Args:
        - translation: torch.Tensor[batch_size, 3], global translation
        - rotation: torch.Tensor[batch_size, 3, 3], global rotation
        - qpos_dict: dict[str, torch.Tensor[batch_size]], joint_name -> qpos
        ...
        - hand_whole_points: torch.Tensor[batch_size, n_points_all, 3], surface points of the whole hand
        """
        batch_size = qpos_dict[self.joint_names[0]].shape[0]
